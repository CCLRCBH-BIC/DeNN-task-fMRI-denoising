...
for subid,sub in enumerate(subjlist):
    tempdatadir = datadir+"/"+sub+"/realsimu_simudatav2.mat"   
    modeldir = datadir+"/"+sub+"/realsimu_modelv2.h5"
    savedatadir = datadir+"/"+sub+"/realsimu_lstmv2.mat"    
    fMRIdata_q,fMRIdata_dwt_q,X,mask,Cor,area = readMat.readMatVars(
            tempdatadir,varname=("fMRIdata","dwt_fMRIdata","X","mask","Cor","area"))  
